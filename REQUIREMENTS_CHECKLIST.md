...
| A2.3 | Interactive controls: Multi-select optimizers, Loss surface dropdown, $\eta$ slider, $\beta$ sliders, $\lambda$ slider, $(x_0, y_0)$ inputs | [x] COMPLETE | Live reactive controls implemented in Streamlit `app.py` (Tab 1) |
